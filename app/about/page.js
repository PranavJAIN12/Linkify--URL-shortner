...
const About = () => {
  const features = [
    ...
    },
    {
      ...
      title: "User Friendly",
      description:
        "Simple and intuitive interface for both beginners and professionals.",
    },
    {
      icon: LineChart,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            we are on a mission to make the web more accessible by providing a
            simple, fast, and reliable way to shorten your URLs.
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Choose a custom alias for your shortened URL or let us
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Copy your shortened URL and share it anywhere you want.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center bg-gray-900 rounded-2xl p-8 border border-gray-800">
          ...
          <p className="text-gray-400 mb-6">
            Join thousands of users who trust our service for their URL
            shortening needs.
          </p>
          <Link href="/shorten">
